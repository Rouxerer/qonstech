...
function Footer() {
  return (
    <div
      className="flex justify-center items-center w-full h-[25%] bg-[#ddd] flex-col"
      style={{
    ...
    >
      <div className="footer_first_container flex w-[80%] h-[48%]">
        <div className="w-[50%] h-full justify-center items-center">
          <img
            src={FullLogo}
            alt="qonstech-full-logo"
            className="w-[70%] h-[100%] object-contain mt-5"
          />
        </div>
        <div className="flex w-[50%] h-full gap-10 justify-center items-center flex-row py-10">
          <div className="contact-col2 flex flex-col gap-3">
            <p className="flex items-center gap-2 text-default">
              <span className="rounded-full bg-gray-300/50">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
              ...
              <span className="text-l text-blue-950">tel: (083) 228 2046</span>
            </p>
            <p className="flex items-center gap-2 text-default">
              <span className="rounded-full bg-gray-300/50">
                <svg
              ...
              <a href="">
                <span className="text-l text-blue-950">www.ororoy.com</span>
              </a>
            </p>
          </div>
          <div className="contact-col2 flex flex-col gap-3">
            <p className="flex items-center gap-2 text-default">
              ...
              <span className="text-l text-blue-950">example@qcc.com</span>
            </p>
            <p className="flex items-center gap-2 text-default">
              <span className="rounded-full bg-gray-300/50">
                <svg
              ...
              <a
                href="https://maps.app.goo.gl/DUYrTGujLLYjwmR6A"
                target="_blank"
              >
                <span className="text-l text-blue-950 ">
                  Cabio Compound, Purok Bumanaag, Brgy. Zone III, City of
                  Koronadal
                </span>
              </a>
            </p>
      ...
      <span className="flex w-[90%] h-[1px] bg-gray-500"></span>
      <div className="footer_first_container flex w-full h-[50%] justify-center items-center flex-col">
        <h6 className="text-blue-950">Social Networks</h6>
        <span className="rounded-full bg-gray-300/50">
          <a href="https://www.facebook.com/QonstechCC" target="_blank">
            <svg
              viewBox="-5 0 20 20"
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
